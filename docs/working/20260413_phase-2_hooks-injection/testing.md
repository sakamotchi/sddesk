...
1. **SDDesk を背面にする**（他のウィンドウをクリック）
2. SDDesk のターミナルで以下を実行して OSC 9 を手動送信:
   ```bash
...
1. SDDesk のターミナルで `claude` にタスクを依頼する
2. SDDesk を背面にする
